...
{ 	
  ...
  SPI_InitTypeDef  SPI_InitStructure;
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5|GPIO_Pin_4;	//PG8 7 推挽 	  
	...
	GPIO_ResetBits(GPIOG,GPIO_Pin_6|GPIO_Pin_5|GPIO_Pin_4);//PG6,7,8上拉					 
...
{														 
	NRF24L01_CE=0;	    
  	...
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RF_CH,40);       //设置RF通道为40  工作通道频数
  	NRF24L01_Write_Reg(NRF_WRITE_REG+RF_SETUP,0x0f);  //设置TX发射参数,0db增益,2Mbps,低噪声增益开启   
